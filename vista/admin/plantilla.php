              ...
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="horarios_ficha.php?ficha=<?php echo $id_ficha ?>&trims=<?php echo "I Trimestre" ?>&IT=<?php echo "1" ?>" class="nav-link <?php if (isset($_GET['IT']) == "1") {
                                                                                                                                                        echo "active";
                                                                                                                                                      }  ?> " style="color: white;">
                    ...
                    <li class="nav-item">
                      <a href="horarios_ficha.php?ficha=<?php echo $id_ficha ?>&trims=<?php echo "II Trimestre" ?>&IIT=<?php echo "2" ?>" class="nav-link <?php if (isset($_GET['IIT']) == "2") {
                                                                                                                                                          echo "active";
                                                                                                                                                        }  ?> " style="color: white;">
                        <i class="fas fa-file-export"></i>
                        <p>II Trimestre</p>
                    ...
                    <li class="nav-item">
                      <a href="horarios_ficha.php?ficha=<?php echo $id_ficha ?>&trims=<?php echo "III Trimestre" ?>&IIIT=<?php echo "3" ?>" class="nav-link <?php if (isset($_GET['IIIT']) == "3") {
                                                                                                                                                            echo "active";
                                                                                                                                                          }  ?> " style="color: white;">
                        <i class="fas fa-file-export"></i>
                        <p>III Trimestre</p>
                    ...
                    <li class="nav-item">
                      <a href="horarios_ficha.php?ficha=<?php echo $id_ficha ?>&trims=<?php echo "IV Trimestre" ?>&IVT=<?php echo "4" ?>" class="nav-link <?php if (isset($_GET['IVT']) == "4") {
                                                                                                                                                          echo "active";
                                                                                                                                                        }  ?> " style="color: white;">
                        <i class="fas fa-file-export"></i>
                        <p>IV Trimestre</p>
                    ...
                    <li class="nav-item">
                      <a href="horarios_ficha.php?ficha=<?php echo $id_ficha ?>&trims=<?php echo "V Trimestre" ?>&VT=<?php echo "5" ?>" class="nav-link <?php if (isset($_GET['VT']) == "5") {
                                                                                                                                                        echo "active";
                                                                                                                                                      }  ?> " style="color: white;">
                        <i class="fas fa-file-export"></i>
                        <p>V Trimestre</p>
                    ...
                    <li class="nav-item">
                      <a href="horarios_ficha.php?ficha=<?php echo $id_ficha ?>&trims=<?php echo "VI Trimestre" ?>&VIT=<?php echo "6" ?>" class="nav-link <?php if (isset($_GET['VIT']) == "6") {
                                                                                                                                                          echo "active";
                                                                                                                                                        }  ?> " style="color: white;">
                        <i class="fas fa-file-export"></i>
                        <p>VI Trimestre</p>
